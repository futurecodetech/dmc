...
bool Currency::init() {
  ...
  if(height==1)
      baseReward = 4807000 * pow(10, 8);
  else if(height>1 && height<=21600)
     baseReward = 118.59375 * pow(10, 8);
  else if(height>21600 && height<=43200)
     baseReward = 83.015625 * pow(10, 8);
   else if(height>43200 && height<=64800)
     baseReward = 56.03554 * pow(10, 8);
   else if(height>64800 && height<=86400)
     baseReward = 34.55525 * pow(10, 8);
   else if(height>86400 && height<=108000)
     baseReward = 16.41374 * pow(10, 8);
   else if(height>108000 && height<=3834000)
     baseReward = 3.60640044 * pow(10, 8);
